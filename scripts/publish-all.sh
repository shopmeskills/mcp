...
echo "  npx -y @shopme/logistics-tracking-mcp"
echo "  npx -y @shopme/cn-ecommerce-search-mcp"
echo "  npx -y @shopme/visual-product-search-mcp"
echo "  npx -y @shopme/xiaohongshu-data-mcp"
echo "  npx -y @shopme/cross-border-price-compare-mcp"
echo "  npx -y @shopme/product-recommendation-mcp"
